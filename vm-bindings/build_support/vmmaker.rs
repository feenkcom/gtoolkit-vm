...
const VMMAKER_LINUX_ARM64_VM_URL: VirtualMachineUrl = VirtualMachineUrl::Pharo("https://github.com/feenkcom/gtoolkit-vm/releases/download/v1.0.42/GlamorousToolkit-aarch64-unknown-linux-gnu.zip");
