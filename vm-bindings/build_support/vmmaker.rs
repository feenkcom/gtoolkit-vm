...
const VMMAKER_LINUX_ARM64_VM_URL: VirtualMachineUrl = VirtualMachineUrl::Pharo("https://files.pharo.org/vm/pharo-spur64-headless/Linux-aarch64/PharoVM-10.0.4-dc9362d-Linux-aarch64-bin.zip");
