...
pipeline {
    ...
    environment {
        ...
        APP_LIBRARIES =              'clipboard filewatcher gleam glutin pixels process skia webview winit winit30 cairo crypto freetype git sdl2 ssl'
        APP_PRO_LIBRARIES =          'editor'
        LINUX_APP_LIBRARIES_AMD =    'clipboard filewatcher gleam glutin pixels process skia webview winit winit30 cairo crypto freetype git sdl2 ssl'
        LINUX_APP_LIBRARIES_ARM =    'clipboard filewatcher gleam glutin pixels process skia webview winit winit30       crypto freetype git      ssl'
        WINDOWS_APP_LIBRARIES_ARM =  'clipboard filewatcher gleam        pixels process skia webview winit winit30       crypto freetype git sdl2 ssl'
