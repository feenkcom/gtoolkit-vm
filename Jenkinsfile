...
pipeline {
    ...
    environment {
        ...
        LINUX_APP_LIBRARIES = 'boxer clipboard filewatcher gleam glutin pixels process skia winit webview test-library cairo crypto freetype git sdl2 ssl'
                    ...
                    steps {
                        ...
                        sh """
                            ./gtoolkit-vm-builder \
                                ...
                                --author ${APP_AUTHOR} \
                                --version ${APP_VERSION} \
                                --libraries clipboard filewatcher gleam glutin pixels process skia webview winit test-library crypto freetype git ssl \
                                --libraries-versions ${APP_LIBRARIES_VERSIONS} \
                                --release \
                                --verbose """
